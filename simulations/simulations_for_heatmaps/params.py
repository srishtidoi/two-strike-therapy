...
parser.add_argument("--n_tau", help="threshold population value at which the second therapy starts", type=int, default=500)
...
parser.add_argument("-t","--therapy", help="effect of therapy on death rate (env 1)", type=float, default=1)
parser.add_argument("-t2","--therapy2", help="treatment parameter for strike 2", type=float, default=1)
